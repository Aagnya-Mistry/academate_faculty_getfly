...
final leaveHistoryProvider =
    StateNotifierProvider<LeaveHistoryNotifier, AsyncValue<List<LeaveRecord>>>(
        (ref) => LeaveHistoryNotifier());

class LeaveHistoryNotifier
    extends StateNotifier<AsyncValue<List<LeaveRecord>>> {
  LeaveHistoryNotifier() : super(const AsyncValue.loading()) {
    _loadLeaveHistory();
  }
...
class LeaveHistoryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      body: CustomScrollView(slivers: [
        ...
        SliverToBoxAdapter(
            child: ref.watch(leaveHistoryProvider).when(
                  loading: () => SizedBox(
                      height: 300,
                      child: Center(
                          child: Column(
                  ...
                  data: (records) => records.isEmpty
                      ...
                      : _buildRecordsList(context, ref, records),
                )),
      ]),
    );
  }
  ...
  Widget _buildEmptyState(BuildContext context) => Padding(
      ...
      child: Column(children: [
        ...
        Text('Start by applying for leave',
  ...
  Widget _buildRecordsList(
          BuildContext context, WidgetRef ref, List<LeaveRecord> records) =>
      Padding(
          ...
          child: Column(
              children: records
                  .asMap()
                  .entries
                  .map((e) => _buildCard(context, ref, e.value, e.key))
                  .toList()));

  Widget _buildCard(
          BuildContext context, WidgetRef ref, LeaveRecord r, int i) =>
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          ...
                          BoxShadow(
                              color: _getStatusColor(r.approvalStatus)
                                  .withOpacity(0.1),
                              blurRadius: 10,
                              spreadRadius: -3)
                        ]),
                              ...
                              children: [
                                ...
                                Row(children: [
                                  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          color: _getLeaveTypeColor(r.leaveType)
                                              .withOpacity(0.1),
                                          borderRadius:
                                              BorderRadius.circular(12)),
                                      child: Icon(_getLeaveIcon(r.leaveType),
                                          size: 18,
                                          color:
                                              _getLeaveTypeColor(r.leaveType))),
                                ...
                                Container(
                                    ...
                                    child: Row(children: [
                                      Expanded(
                                        ...
                                        Text(
                                            '${r.fromDate.day}/${r.fromDate.month}/${r.fromDate.year}',
                                            style: GoogleFonts.inter(
                                                fontSize: 14,
                                                fontWeight: FontWeight.w700,
                                      ...
                                      Expanded(
                                        ...
                                        const SizedBox(height: 4),
                                        Text(
                                            '${r.toDate.day}/${r.toDate.month}/${r.toDate.year}',
                                            style: GoogleFonts.inter(
                                                fontSize: 14,
                                                fontWeight: FontWeight.w700,
  ...
  Widget _buildErrorState(BuildContext context, WidgetRef ref) => Padding(
      padding: const EdgeInsets.all(32),
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        ElevatedButton.icon(
            onPressed: () =>
                ref.read(leaveHistoryProvider.notifier).refreshLeaveHistory(),
            icon: const Icon(Icons.refresh_rounded),
